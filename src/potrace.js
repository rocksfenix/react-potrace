...
var Potrace = (function () {
  ...
  Bitmap.prototype.copy = function () {
    var bm = new Bitmap(this.w, this.h); var i
  ...
  function bmToPathlist () {
    ...
    function xorPath (path) {
      var y1 = path.pt[0].y
      var len = path.len
      var x; var y; var maxX; var minY; var i; var j
      for (i = 1; i < len; i++) {
        x = path.pt[i].x
        y = path.pt[i].y
  ...
  function processPath () {
    ...
    function quadform (Q, w) {
      var v = new Array(3); var i; var j; var sum
    ...
    function calcLon (path) {
      var n = path.len; var pt = path.pt; var dir
      ...
      var i; var j; var k1; var a; var b; var c; var d; var k = 0
      for (i = n - 1; i >= 0; i--) {
    ...
    function bestPolygon (path) {
      function penalty3 (path, i, j) {
        var n = path.len; var pt = path.pt; var sums = path.sums
        var x; var y; var xy; var x2; var y2
        var k; var a; var b; var c; var s
        var px; var py; var ex; var ey
        var r = 0
        if (j >= n) {
          j -= n
          r = 1
    ...
    function adjustVertices (path) {
      function pointslope (path, i, j, ctr, dir) {
        var n = path.len; var sums = path.sums
        var x; var y; var x2; var xy; var y2
        var k; var a; var b; var c; var lambda2; var l; var r = 0
      ...
      var m = path.m; var po = path.po; var n = path.len; var pt = path.pt
      var x0 = path.x0; var y0 = path.y0
      var ctr = new Array(m); var dir = new Array(m)
      var q = new Array(m)
      var v = new Array(3); var d; var i; var j; var k; var l
      var s = new Point()
    ...
    function reverse (path) {
      var curve = path.curve; var m = curve.n; var v = curve.vertex; var i; var j; var tmp
    ...
    function smooth (path) {
      var m = path.curve.n; var curve = path.curve
    ...
    function optiCurve (path) {
      ...
      function opti_penalty (path, i, j, res, opttolerance, convc, areac) {
        var m = path.curve.n; var curve = path.curve; var vertex = curve.vertex
        var k; var k1; var k2; var conv; var i1
        var area; var alpha; var d; var d1; var d2
        var p0; var p1; var p2; var p3; var pt
        var A; var R; var A1; var A2; var A3; var A4
        var s; var t
      ...
      var curve = path.curve; var m = curve.n; var vert = curve.vertex
      var pt = new Array(m + 1)
      var pen = new Array(m + 1)
      var len = new Array(m + 1)
      var opt = new Array(m + 1)
      var om; var i; var j; var r
      var o = new Opti(); var p0
      var i1; var area; var alpha; var ocurve
      var s; var t

      var convc = new Array(m); var areac = new Array(m + 1)
  ...
  function getSVG (size, opt_type) {
    ...
    var w = bm.w * size; var h = bm.h * size
    var len = pathlist.length; var c; var i; var strokec; var fillc; var fillrule
